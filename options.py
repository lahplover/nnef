...
def get_et_parser():
    ...
    parser.add_argument("--use_nn_energy", action='store_true', default=False)
    parser.add_argument("--use_nn_transition", action='store_true', default=False)

    parser.add_argument("--embed_dim", type=int, default=64)
    parser.add_argument("--noise_dim", type=int, default=64)
    parser.add_argument("--msg_dim", type=int, default=128)
    parser.add_argument("--energy_feats_dim", type=int, default=128)
    parser.add_argument("--n_layers_transition", type=int, default=4)
    parser.add_argument("--n_layers_energy", type=int, default=4)
    parser.add_argument("--n_layers_entropy", type=int, default=4)
    parser.add_argument("--dropout", type=float, default=0)
    ...
    parser.add_argument("--use_decoy_as_native_ensemble", action='store_true', default=False)
    parser.add_argument("--ET_share_sample", action='store_true', default=False)
    parser.add_argument("--spec_norm", action='store_true', default=False)
    parser.add_argument("--egnn", action='store_true', default=False)
    parser.add_argument("--recal_edge", action='store_true', default=False)
    parser.add_argument("--egnn_max_move", type=float, default=1.0, help='max coordinate move in EGNN layer')
    parser.add_argument("--energy_sigmoid", action='store_true', default=False)
    parser.add_argument("--seq_mutations", action='store_true', default=False)
    parser.add_argument("--random_seq", action='store_true', default=False)
    parser.add_argument("--kT", type=float, default=1.0, help='sigma of the gaussian noise in the corruption')
    parser.add_argument("--random_kT", action='store_true', default=False)
    parser.add_argument("--gradx_step", type=float, default=100.0)
    parser.add_argument("--disable_transition_noise_z", action='store_true', default=False)
    parser.add_argument("--starting_x_decoy_prob", type=float, default=0.1)
    parser.add_argument("--grad_kl", action='store_true', default=False)
    parser.add_argument("--grad_kl_weight", type=float, default=10.0)
    parser.add_argument("--nn_entropy_training", action='store_true', default=False)
    parser.add_argument("--entropy_loss_weight", type=float, default=10.0)
    parser.add_argument("--entropy_neighbor", action='store_true', default=False)
    parser.add_argument("--entropy_neighbor_weight", type=float, default=1.0)
    parser.add_argument("--local_constraint_weight", type=float, default=1.0)
    parser.add_argument("--buffer_size", type=int, default=10)

    parser.add_argument("--n_steps", type=int, default=1)
    parser.add_argument("--folding_steps", type=int, default=1)
    parser.add_argument("--E_optim", type=str, default='SGD', help='optimizer of energy model')
    parser.add_argument("--T_optim", type=str, default='SGD', help='optimizer of transition model')
    parser.add_argument("--lr", type=float, default=1e-5)
    parser.add_argument("--lr_T", type=float, default=1e-5)
    parser.add_argument("--betas", default=(0.5, 0.9))   # (0.9, 0.99), (0.5, 0,9) ?
    parser.add_argument("--weight_decay", type=float, default=1e-4, help='L2 weight regularization')
    parser.add_argument("--n_warmup_steps", type=int, default=5000)
    parser.add_argument("--steps_decay_scale", type=int, default=10000)
    ...
    parser.add_argument("--log_interval", type=int, default=100)
    parser.add_argument("--save_interval", type=int, default=10)
    parser.add_argument("--save_path", type=str, default='./runet/', help='path to save learned models')

    parser.add_argument("--run_test", action='store_true', default=False)
    parser.add_argument("--test_update_x", action='store_true', default=False)
    parser.add_argument("--test_batch_size", type=int, default=1)
    parser.add_argument("--test_n_steps", type=int, default=10)
...
def get_ed_parser():
    ...
    parser.add_argument("--kT", type=float, default=1.0, help='sigma of the gaussian noise in the corruption')
    parser.add_argument("--starting_x_decoy_prob", type=float, default=0.1)
    parser.add_argument("--entropy_training", action='store_true', default=False)
    parser.add_argument("--entropy_loss_weight", type=float, default=10.0)
    parser.add_argument("--entropy_neighbor", action='store_true', default=False)
    parser.add_argument("--entropy_neighbor_weight", type=float, default=1.0)
    parser.add_argument("--local_constraint_weight", type=float, default=1.0)
    parser.add_argument("--buffer_size", type=int, default=10.0)
    parser.add_argument("--gradx_step", type=float, default=100.0)
...
def et_get_decoy_parser():
    parser = get_et_parser()
